...
[[zelenobřeh.png]]
```leaflet  
id: zelenobreh ### Must be unique with no spaces  
image: [[zelenobřeh.png]] ### Link to the map image file. Do not add a ! in front of the image  
bounds: [[0,0], [4105, 4086]] ### Size of the map in px Height_y, Width_x. Ignore 0,0  
height: 1000px ### Size of the leaflet embed in px on your screen  
width: 100% ### Size of the leaflet embed in your note  
lat: 2052 ### To center the map, make this half of the map height.  
long: 2043 ### To center the map, make this half of the map width.  
